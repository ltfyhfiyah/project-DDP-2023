...
canvas = Canvas(root, bg='#2a2a2a', height=HEIGHT, width=WIDTH)
canvas.pack()
...
frameInput = Frame(root, bg="#677063")
...
tolabel = Label(frameInput, text='to', fg='white', bg='#677063')
...
suhuOutput.get()
numOutput = Entry(frameInput)
numOutput.place(relx=0.97,rely=0.5,relwidth=0.15,relheight=0.8,anchor='e')
numOutput.get()
